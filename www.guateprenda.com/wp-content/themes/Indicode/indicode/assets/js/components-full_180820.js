...
(function($) {
    ...
    $(window).on('load', indi_animated_cols);
...
(function($) {
    ...
    if ( $blog.hasClass('mk-blog-container-lazyload') && $imgs.length ) {
        ...
        $(window).on('scroll.indi_blog_lazyload', MK.utils.throttle(500, function(){
        ...
        $(window).trigger('scroll.indi_blog_lazyload');
...
(function($) {
	...
	MK.component.EdgeSlider = function( el ) {
        ...
        // Let indi_slider know it's EdgeSlider
...
jQuery(function($) {
  ...
  if ( $gallery.hasClass('mk-gallery-lazyload') && $imgs.length ) {
    ...
    // Load Images if the user scrolls to them
    $(window).on('scroll.indi_gallery_lazyload', MK.utils.throttle(500, function(){
      $imgs.each(function(index, elem) {
        if ( MK.utils.isElementInViewport(elem) ) {
          MK.component.ResponsiveImageSetter.init( $(elem) );
          $imgs = $imgs.not( $(elem) );  // Remove element from the list when loaded to reduce the amount of iteration in each()
    ...
    $(window).trigger('scroll.indi_gallery_lazyload');
...
(function($) {
  ...
  function indi_section_intro_effects() {
  ...
  indi_section_intro_effects();

  var debounceResize = null;
  $(window).on("resize", function() {
    if( debounceResize !== null ) { clearTimeout( debounceResize ); }
    debounceResize = setTimeout( indi_section_intro_effects, 300 );
  });
  
  /* Page Section Adaptive Height */
  /* -------------------------------------------------------------------- */
    
  function indi_section_adaptive_height() {
  ...
  $( window ).on( "load resize", indi_section_adaptive_height );
  ...
  if ( $allLayers.length ) {
    ...
    $(window).on('scroll.indi_page_section_lazyload', MK.utils.throttle(500, function(){
    ...
    // First init
    $(window).trigger('scroll.indi_page_section_lazyload');
  ...
  function indi_section_half_layout() {
    $(".mk-page-section.half_boxed").each(function() {
      var $section = $(this);
      if ($(window).width() > indi_grid_width) {
        var margin = ($(window).width() - indi_grid_width) / 2;
  ...
  $(window).on("load resize", indi_section_half_layout);
...
(function($) {
	...
	function indi_page_title_parallax() {
	    if (!MK.utils.isMobile() && indi_smooth_scroll !== 'false') {
	...
	$window.on('load', indi_page_title_parallax);
    $window.on("resize", function() {
        if( debounceResize !== null ) { clearTimeout( debounceResize ); }
        debounceResize = setTimeout( indi_page_title_parallax, 300 );
    });
...
jQuery(function($) {
  ...
  if ( $portfolio.hasClass('portfolio-grid-lazyload') && $imgs.length ) {
    ...
    // Load Images if the user scrolls to them
    $(window).on('scroll.indi_portfolio_lazyload', MK.utils.throttle(500, function(){
      $imgs.each(function(index, elem) {
        if ( MK.utils.isElementInViewport(elem) ) {
          MK.component.ResponsiveImageSetter.init( $(elem) );
          $imgs = $imgs.not( $(elem) );  // Remove element from the list when loaded to reduce the amount of iteration in each()
    ...
    $(window).trigger('scroll.indi_portfolio_lazyload');
...
(function( $ ) {
    ...
    if ( $swiper.hasClass('mk-swipe-slideshow-lazyload') && $imgs.length ) {
        ...
        // Load Images if the user scrolls to them
        $(window).on('scroll.indi_swipe_slideshow_lazyload', MK.utils.throttle(500, function(){
            $imgs.each(function(index, elem) {
                if ( MK.utils.isElementInViewport(elem) ) {
                    MK.component.ResponsiveImageSetter.init( $(elem) );
                    $imgs = $imgs.not( $(elem) );  // Remove element from the list when loaded to reduce the amount of iteration in each()
        ...
        $(window).trigger('scroll.indi_swipe_slideshow_lazyload');
...
(function($) {
	...
	$(window).on('load', indi_video_play);

	// Resize icon size for responsive layout
	function indi_video_resize_play_icon() {
	...
	$(window).on('load resize orientationChange', indi_video_resize_play_icon);
}(jQuery));