...
$dinero = $_POST['dinero1'];
$articulo = $_POST['articulo1'];
$caracteristica = $_POST['caracteristica1'];
$nombre = $_POST['nombre1'];
$telefono = $_POST['telefono1'];
$correo = $_POST['correo1'];
$selectpaisesid = $_POST['selectpaisesid1'];
$selectestado = $_POST['selectestado1'];
...
if($dinero == '' or $articulo == '' or $caracteristica == '' or $nombre == '' or $telefono == '' or $correo == ''){
